...
test(`multiple alias`, testRule({
  valid: [
    {
      code,
      filename: '/foo/bar/Url.js',
      options: [['camelcase','PascalCase']],
    },
    {
      code,
      filename: '/foo/bar/AnotherModule.js',
  ...
  invalid: [
    {
      ...
      options: [['camelcase','PascalCase']],
      errors: [
        { message: `Filename 'another-module.js' does not match camelcase,PascalCase.`, column: 1, line: 1 },
      ],
    },
    {
      code,
      ...
      options: [['camelcase','PascalCase']],
      errors: [
        { message: `Filename 'another_module.js' does not match camelcase,PascalCase.`, column: 1, line: 1 },
      ],
    },
  ],
}));
